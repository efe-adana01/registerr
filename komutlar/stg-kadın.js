...
if(!['803888632451956766'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) 
...
const tag = '乡'   
const kadınrol = message.guild.roles.cache.find(r => r.id === '803888662668378152') 
const kadınrol2 = message.guild.roles.cache.find(r => r.id === '803888664794234881')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '803888634813349929')
const genelchat = message.guild.channels.cache.find(c => c.id === '803888794796556308')
const savelog = message.guild.channels.cache.find(c => c.id === '803945345699545130')
